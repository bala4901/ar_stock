...
class product_reservation(osv.osv):
	_name = 'stock.product_reservation'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(product_reservation, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(product_reservation, self).unlink(cr, uid, ids, context)
	...
	def action_process(self, cr, uid, ids, context=None):
		...
		result = super(product_reservation, self).action_process(cr, uid, ids, context)
