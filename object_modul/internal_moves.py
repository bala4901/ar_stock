...
class internal_moves(osv.osv):
	_name = 'stock.internal_moves'
	_inherit = 'stock.picking'
	_table = 'stock_picking'
	_description = 'Internal Moves'
	_order = 'name'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(internal_moves, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(internal_moves, self).unlink(cr, uid, ids, context)
	...
	def action_process(self, cr, uid, ids, context=None):
		...
		result = super(internal_moves, self).action_process(cr, uid, ids, context)
