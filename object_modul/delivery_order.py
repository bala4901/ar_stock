...
class delivery_order(osv.osv):
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(delivery_order, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(delivery_order, self).unlink(cr, uid, ids, context)
	...
	def action_process(self, cr, uid, ids, context=None):
		...
		result = super(delivery_order, self).action_process(cr, uid, ids, context)
