...
class customer_claim(osv.osv):
	_name = 'stock.customer_claim'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(customer_claim, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(customer_claim, self).unlink(cr, uid, ids, context)
	...
	def action_process(self, cr, uid, ids, context=None):
		...
		result = super(customer_claim, self).action_process(cr, uid, ids, context)
