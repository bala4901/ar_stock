...
class supplier_claim(osv.osv):
	_name = 'stock.supplier_claim'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(supplier_claim, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(supplier_claim, self).unlink(cr, uid, ids, context)
	...
	def action_process(self, cr, uid, ids, context=None):
		...
		result = super(supplier_claim, self).action_process(cr, uid, ids, context)
